<template>
  <div class="documentation main-content">
    ...
    <p>
      ...
      <i>String</i> and <i>Boolean</i>, these specs are explained thoroughly in
      coming sections. There is also a fourth datatype <i>Void</i> that stands
    ...
    <p>
      ...
      <i>functions</i> and these functions must be called from within a single
      function <b>main</b> that returns, yeah you guessed it, <b>void</b>. The
      reason behind this, at least for <b>Miria</b>, it's because it's so much
      easier to parse than having to write every possible grammatical rule in a
      <i>top level statement</i>. Of course you, the programmer, do not care
      about this, your only concern is how to write a <i>Hello World</i> program
      in <b>Miria</b>, and it's as simple as:
    </p>
    <pre>
    ...
    <p>
      ...
      of expressions of some sort (sorry HTML). But, what are expressions?
      First, we must define what an <b>statement</b> is, an statement is just a
    ...
    <p>
      ...
      that's when <b>variables</b> come in. Let's say you want to print a very
    ...
    >
    <p>
      The <b>range</b> function takes exactly two arguments and returns a list
